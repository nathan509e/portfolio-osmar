          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <a href={WA_LINK} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-[hsl(195,70%,45%)] text-white font-body text-xs tracking-widest px-8 py-4 rounded-full hover:bg-[hsla(212, 70%, 38%, 1.00)] transition-all duration-300 shadow-lg shadow-blue-900/40">
